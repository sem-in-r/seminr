...
- Partial Least Squares Path Modeling (PLS-PM)
  ...
  - *Out-of-sample prediction* via PLSpredict with k-fold CV and LOOCV, supporting
    all interaction methods (`two_stage`, `product_indicator`, `orthogonal`)
...
The **vignette** for Seminr can be found on [GitHub](https://github.com/sem-in-r/seminr) or by running the `vignette("SEMinR")` command after installation.
