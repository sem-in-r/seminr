...
The goals of SEMinR compared to other R packages for PLS and SEM:
1. Powerful syntax for model definition:
  - Estimation-agnostic modeling syntax: define generic SEM models, specify estimation method after (only PLS for now)
  - Multiple measurement models for constructs (reflective common-factor, formative-composite, formative-causal)
...
1. Programmatic approach: use the full power of R
