...
SEMinR can plot models using the DiagrammeR packages with a simple `plot` method.
...
save_plot("man/figures/model_pls.png", width = 2400, plot = pl)
```
...
Researchers can now create a SEM and estimate it using different techniques (PLS-PM, CBSEM).
