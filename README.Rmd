...
The vignette for Seminr can be found in the [CRAN](https://cran.r-project.org/web/packages/seminr/vignettes/SEMinR.html) folder or by running the `vignette("SEMinR")` command after installation.
