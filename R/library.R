...
#' Outer weighting scheme functions to estimate construct weighting.
#'
#' \code{mode_plsc} specifies outer weighting as mode A and then applies PLSc disattenuation
#' to mimic common-factor model estimates.
#'
#' @param mmMatrix is the \code{measurement_model} - a source-to-target matrix
#' representing the measurement model, generated by \code{constructs}.
#'
#' @param j is the name of the construct to be estimated.
#'
#' @param normData is the dataframe of the normalized item data.
#'
#' @param construct_scores is the matrix of construct scores generated by \code{estimate_model}.
