...
#' \code{seminr::estimate_model} provides the verb for estimating a pls model from the plsm object
#' generated by \code{seminr::create_model}.
#'
#' @param seminr_model A \code{plsm} object generated by the \code{seminr::create_model} function
#'
...
#' @export
estimate_model <- function(seminr_model, ...) {
