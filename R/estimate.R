#' seminr Model Estimation Function
#'
...
#' \code{seminr::estimate} provides the verb for estimating a pls model from the plsm object
#' generated by \code{seminr::model}.
#'
#' @param seminr_model A \code{plsm} object generated by the \code{seminr::model} function
#'
#' @param ... A list of parameters inherited from the estimation function (default is semPLS)
#'
#' @usage
#' estimate(seminr_model, ...)
#'
