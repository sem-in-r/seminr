...
#' meaning that once a model is specified, it can be used across models for comparison. \code{model}
...
#'
#' @usage
#' model(data, measurement_model, interactions=NULL, structural_model)
#'
