...
It is important to note that a single-item constructs can be defined as either composite mode A or reflective common-factor, but they are essentially composites whose construct scores are determined.
