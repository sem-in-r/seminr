...
- change measurement weighting to functions DONE
- WARNING: for dots in names of columns DONE
- check citations and references DONE
- equivalent R code for single_item DONE??
- paths example from single antecedant to single outcome DONE??
- check summary reporting of cross-loadings DONE??
...
* Continuously tested against leading PLS path modeling (PLSPM) software such as [SmartPLS](http://www.smartpls.com) and ADANCO (Henseler and Dijkstra, 2015), as well as other R packages for PLSPM such as semPLS (Monecke and Leisch, 2012) and matrixpls (Rönkkö, 2016), to ensure parity of outcomes
...
* Rönkkö, M. (2016). R package matrixpls: Matrix-based partial least squares estimation (version 0.7.0). http://cran.r-project.org/web/packages/matrixpls/ 
