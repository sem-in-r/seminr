...
It takes as parameters the structural model described by `relationships()`, the measurement model described by `measure()` and an optional interactions function as described by `interact()`.
