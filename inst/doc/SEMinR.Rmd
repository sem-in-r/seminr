...
*Important:* Avoid stars '*' in your column names (these are reserved for interaction terms).
...
**Important Note:** SEMinR syntax uses a star "*" as a naming convention for the interaction construct. Thus, the "Image" + "Expectation" interaction is called "Image.Expectation" in the structural model below. Please refrain from using a star "*" in the naming of non-interaction constructs.
