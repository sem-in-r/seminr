...
It takes as parameters the structural model described by `relationships()`, the measurement model described by `constructs()` and an optional interactions function as described by `interact()`.
